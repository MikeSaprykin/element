                    ...
                    _vm._l(_vm.selected, function(item) {
                      return _c(
                        ...
                        [
                          _vm.tagComponent
                            ? [
                                _vm.selectedItem(item.value)
                                  ? _c(
                                      "div",
                                      { staticClass: "el-image__tag" },
                                      [
                                        _c(
                                          "div",
                                          {
                                            staticClass:
                                              "el-image__tag-image-wrapper",
                                            on: {
                                              click: function($event) {
                                                _vm.deleteTag($event, item)
                                              }
                                          ...
                                          [
                                            ...
                                            _c(
                                              ...
                                              [
                                                _c("i", {
                                                  staticClass:
                                                    "el-tag__close el-icon-close el-image__tag-close-icon"
                                                })
                                              ]
                                            )
                                          ]
                                        ...
                                        _c(
                                          "span",
                                          { staticClass: "el-image__tag-text" },
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  methods: {
    selectedItem: function selectedItem(value) {
      return this.selectOptions.find(function (option) {
